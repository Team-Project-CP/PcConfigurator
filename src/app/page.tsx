...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    if (!loading) {
      ...
      AOS.init({
        ...
        easing: "ease-out",
        once: true,
        offset: 100, // Trigger animations 100px before the element enters the viewport
      });
      AOS.refresh(); // Refresh AOS to detect elements after loading
  ...
  }, [loading]); // Re-run this effect when `loading` changes
  ...
  return (
    <div>
      ...
      {/* Stats */}
      <div data-aos="fade-up" className="bg-black py-24 sm:py-20">
      ...
      {/* Features */}
      <div data-aos="fade-up" className="flex space-x-8 justify-center items-center mt-12 min-h-[500px]">
        <div className="flex flex-col items-center bg-gray-100 rounded-xl p-6 shadow-lg w-100 h-[400px] justify-center">
          ...
          <p className="text-center text-gray-600">
            Every product undergoes thorough testing to <br />ensure top-notch quality and durability, <br />meeting the highest standards
          </p>
        </div>
        <div className="flex flex-col items-center bg-gray-100 rounded-xl p-6 shadow-lg w-100 h-[400px] justify-center">
          ...
          <p className="text-center text-gray-600">
            Enjoy peace of mind with our 2-year warranty. <br /> We're here to support you if any <br />issues arise within this period
          </p>
        </div>
        <div className="flex flex-col items-center bg-gray-100 rounded-xl p-6 shadow-lg w-100 h-[400px] justify-center">
          ...
          <p className="text-center text-gray-600">
            Our fast-build service ensures quick <br /> delivery without sacrificing quality, <br /> getting your project done on time
          </p>
        </div>
      </div>

      {/* Promo */}
      <div data-aos="fade-up" className="bg-white py-16">
        <div className="mx-8">
      ...
      {/* Build Together */}
      <div data-aos="fade-up" className="bg-gradient-to-r from-blue-900 to-purple-900 text-white py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-8 text-center shadow-lg">
              ...
              <p className="text-gray-600 mb-6">
                Whether you want to play popular games, get eye-catching visuals, or hit peak FPS, our Prebuilts got you covered from mid-range to top-of-the-line GPUs and CPUs.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mt-6">
            <div className="relative group">
              <img src="/PartnerLogos.png" className="w-full max-w-2xl h-auto transition-transform duration-500" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div data-aos="fade-up" className="bg-gray-50 py-16">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    The Central Processing Unit multitasks well as increases performance in CPU-intensive games and helps avoid bottlenecks.
                  </p>
                </div>
              </div>
              <div className="flex items-start">
