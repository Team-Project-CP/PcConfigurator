(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_Components_[id]_page_tsx_f758ec69._.js", {
            ...
            const fetchData = {
                "ComponentDetail.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        const componentData = await fetch(`/api/components/${params.id}`).then({
                            "ComponentDetail.useEffect.fetchData": (res)=>res.json()
                        }["ComponentDetail.useEffect.fetchData"]);
                        setComponent(componentData);
                        const recommendedData = await fetch(`/api/components/${params.id}/recommendations`).then({
                            "ComponentDetail.useEffect.fetchData": (res)=>res.json()
                        }["ComponentDetail.useEffect.fetchData"]);
...
//# sourceMappingURL=src_app_Components_%5Bid%5D_page_tsx_f758ec69._.js.map